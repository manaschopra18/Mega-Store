...
<td>
<article><b style="font-size:28; color:#006699"><%out.println(rs.getString(2));%></b><br> <br><b>QUANTITY: </b>&nbsp <%out.println(rs.getString(3));%><br> <b>DESCRIPTION:</b><br>&nbsp
<%out.println(rs.getString(5));%>
<br><br><b style="font-size:26">Price :<%out.println(rs.getString(4));%>/-</b><p align="right" style="margin-right:85px"><button class="button2">ADD TO CART</button></p></article>
</td>
</tr>
</table>
</div>
