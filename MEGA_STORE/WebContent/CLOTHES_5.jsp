...
String query = "Select * from clothes,clothes1 where clothes.barcode=clothes1.barcode";
...
<tr>
<td>
 <img width="180px" height="250px" src="<%out.println(rs.getString(9));%>" onError="loadImage()" onAbort="loadImage()"/>
</td>
<td>
<article><b style="font-size:26; color:#006699"><%out.println(rs.getString(2));%> </b><br> <br><b>FABRIC:</b>&nbsp <%out.println(rs.getString(4));%> <br> <b>DESCRIPTION:</b><br>&nbsp<%out.println(rs.getString(6));%>
<br><br><b style="font-size:26">Price :<%out.println(rs.getInt(5));%>/-</b><br>
<b style="font-size:26">Color: <%out.println(rs.getString(13));%></b><br><b style="font-size:26">Size: <%out.println(rs.getString(11));%></b><br>
